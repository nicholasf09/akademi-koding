<template>
  <div class="text-black p-4 flex items-center fixed w-full justify-between top-0 border-b bg-violet-100 border-gray-700 z-50">
    <a href="/register" class="bg-violet-500 hover:bg-violet-700 text-white font-bold py-2 px-4 rounded">Back To Courses</a>
    <h1 class="text-lg font-semibold mx-8 cursor-pointer">Current Course: {{ moduleTitle }}</h1>
    <a href="/register" class="bg-violet-500 hover:bg-violet-700 text-white font-bold py-2 px-4 rounded">Go To Projects</a>
  </div>
